...
\begin{proof}
Let $\{I_1, I_2, \dots, I_k\}$ be the Grassmann necklace associated $\Sigma(W)$. From (THEOREM NUMBER) in \cite{generalcombinatoricsII},
%
\begin{displaymath}
...
\bas C(W) =
\begin{bmatrix}
c_{p,1} & c_{p,2} & c_{p,3} &c_{p,4} & 0 & 0 \\
c_{q,1} & c_{q,2} &c_{q,3} & c_{q,4} &  0 & 0
\end{bmatrix}.\eas
\noindent
