...
Note that not every co-dimension one boundary of a $\Sigma(W)$ do not contain a factor of $R(W)$. Also note that this example occurs in a situation where there isn't another minimal parametrization of the cell.

\begin{eg}
Show boundaries of $\Sigma(V_i)$ and the factors of $R(V_i)$.
\end{eg}
